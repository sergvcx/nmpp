...
typedef struct s_nm32fcr
{
    ...
    /**
	\ingroup nmvectype
    \ru векторный тип данных с плавающей точкой одинарной точности (float).
	\details Используется для идентификации массива данных типа float, предназначенных для обработки на векторном 
	 сопроцессоре с плавающей точкой. Указатель на данный тип данных всегда должен быть выровнен по четному адресу.
...
typedef float  nm32f;
    ...
    /**
	\ingroup nmvectype
    \ru векторный тип данных с плавающей точкой двойной точности (double).
	\details Используется для идентификации массива данных типа double, предназначенных для обработки на векторном 
	 сопроцессоре с плавающей точкой. Указатель на данный тип данных всегда должен быть выровнен по четному адресу.
	*/
