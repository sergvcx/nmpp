...
//! \fn void nmppsConvert_16s(nm16s* pSrc,nm8s* pDst,int)	
int main()
{
	...
	for(short nSize=0;nSize<shortTestSize;nSize+=8*NMPP_MIN_REP)
	{
		nmppsConvert_16s8s((nm16s*)L0,(nm8s*)G0,nSize);	
