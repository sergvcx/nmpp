...
// void nmppsMul_Mul_Add_32f(const nm32f *pSrcVec1, const nm32f *pSrcVec2, nm32f *pSrcVec3, nm32f *pSrcVec4, nm32f *pDstVec, int nSize)
// x1 - pSrcVec1
// y1 - pSrcVec2
// x2 - pSrcVec3
// y2 - pSrcVec4
...
global _nmppsMul_Mul_Add_32f: label;
begin ".text_nmplv"
<_nmppsMul_Mul_Add_32f>
	ar5 = ar7 - 2;
	push ar4, gr4;
	push ar3, gr3;
	push ar2, gr2;
	...
	if =0 goto less64_MulMulAdd_32f;
...
<MulMulAdd_32f>
	...
	gr1--;
	if > delayed goto MulMulAdd_32f;
		fpu 2 .float vreg2 = vreg0 + vreg1;
		fpu 2 rep 32 [ar4++] = vreg2;

	gr0 = gr0 << 26;
	gr0 = gr0 >> 26;		// remainder
<less64_MulMulAdd_32f>
	gr0 = gr0 >> 1;
	if =0 delayed goto exit_MulMulAdd_32f;
		gr0--;
		vlen = gr0;
