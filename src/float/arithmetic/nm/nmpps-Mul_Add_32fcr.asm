...
global _nmppsMul_Add_32fcr: label;
//void nmppsMul_Add_32fcr(nm32fcr* pSrcVec1, nm32fcr* pSrcVec2, nm32fcr* pSrcVecAdd, nm32fcr* pDstVec, int nSize);
// x1 - pSrcVec1
// x2 - pSrcVec2
// x3 - pSrcVecAdd
// f - pDstVec
...
<Next32>
	...
	fpu 0 .complex vreg6 = vreg0*vreg1; 
...
<Tail>	
	...
	fpu 0 .complex vreg7 = vreg0*vreg1+vreg2; 
