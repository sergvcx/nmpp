...
//--------------------------------------------------------------------
//! \fn void nmppmMul_mm_8s16s( nm8s* pSrcMtr1, int nHeight1, int nWidth1,  nm16s* pSrcMtr2, nm16s* pDstMtr, int nWidth2)
//!
//! \perfinclude nmppmMul_mm_8s16s.html
//--------------------------------------------------------------------
...
global _nmppmMul_mm_8s16s:label;
<_nmppmMul_mm_8s16s>
.branch;
