...
macro VEC_ACCMUL_REP(N)
    ...
    //------------------------------------------------------------------------
    //! \fn void core_vsum_data_afifo(nmreg nb1, nmreg sb, nmreg woper, nmreg ar0, nmreg gr0, nmreg gr5, nmreg ar6)
    //!
    //------------------------------------------------------------------------

global core_vsum_data_afifo:label;
<core_vsum_data_afifo>
.branch;
	AccMul_rep0:label;
