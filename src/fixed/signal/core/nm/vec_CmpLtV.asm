...
Cmp_rep0:label;
    ...
    //------------------------------------------------------------------------
    //! \fn void core_CmpLTV(nmreg nb1,nmreg sb, nmreg ar0, nmreg gr0, nmreg ar1, nmreg gr1, nmreg gr5, nmreg ar6, nmreg gr6 )
    //!
    //------------------------------------------------------------------------

global core_CmpLtV :label;
<core_CmpLtV>
.branch;
	...
	if <>0 delayed goto LTxt_Cmp_rep32 with gr5--;	
