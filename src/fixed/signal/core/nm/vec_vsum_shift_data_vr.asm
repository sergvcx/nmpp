...
macro VEC_MUL_SHIFT_DATA_VR_REP(N)
    ...
    //------------------------------------------------------------------------
    //! \fn void core_vsum_shift_data_vr(nmreg nb1, nmreg sb, nmreg woper, nmreg vr, nmreg ar0, nmreg gr0, nmreg ar1, nmreg gr1, nmreg gr5, nmreg ar6, nmreg gr6)
    //!
    //------------------------------------------------------------------------

global core_vsum_shift_data_vr :label;
<core_vsum_shift_data_vr>
.branch;
