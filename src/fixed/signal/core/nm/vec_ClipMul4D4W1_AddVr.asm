...
.if (NMPP_MIN_REP <= N);
		...
		nul;
.endif;
end MTR_MUL4D4W1_REP;

    //------------------------------------------------------------------------
    //! \fn void core_ClipMul4D4W1_AddVr(nmreg nb1, nmreg sb, nmreg F1CR, nmreg vr, nmreg ar0, nmreg gr0, nmreg ar1, nmreg gr1, nmreg ar2, nmreg gr2, nmreg ar3, nmreg gr3, nmreg ar4, nmreg gr4, nmreg gr5, nmreg ar6, nmreg gr6)
    //!
    //------------------------------------------------------------------------

global core_ClipMul4D4W1_AddVr:label;
      <core_ClipMul4D4W1_AddVr>
.branch;
	Mul4D4W1_AddVr_rep0:label;
	...
	if =0 delayed goto Mul4D4W1_AddVr_repN with gr7--;
		ar4 = ar5	with gr5>>=24;
		with gr7;
	...
	Next_Mul4D4W1_AddVr_rep32:label;
	gr4=Next_Mul4D4W1_AddVr_rep32;
	<Next_Mul4D4W1_AddVr_rep32>
