...
//! \param  vr	константа для суммирования 
//!
//! \param ar0	SrcMtr1		
...
//!
//! \param ar2  f1cr для первой группы (адрес ячейки long).
//! \param gr2  f1cr для второй группы (адрес ячейки long).
//!
//! \param ar3  sb для первой группы (адрес ячейки long).
//! \param gr3  sb для второй группы (адрес ячейки long).
//!
//! \param ar4  2 матрицы весовых коэффициентов по 8 64р. слов
//! \param gr4  дублирует nb1 
//!
//! \param gr5  Высота матриц N = [0,1,2...31,32,33,...]
//!
//! \param ar6  DstVec							
//! \param gr6  DstVec  stride 
//!
//!
//! \restr При выходе из функции изменяется содержимое регистров:
//! ar0,ar1,ar6,gr7
//------------------------------------------------------------------------
