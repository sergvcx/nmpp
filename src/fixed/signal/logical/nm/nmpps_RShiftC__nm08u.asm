...
data ".data_nmplv_G"
		...
		core_tbl_nb_sb_char_RSH:word[16]=(
			082828282h,// nb sh0
			00a0a0a0ah,// sb sh0
			0c2c2c2c2h,// nb sh1
			00a0a0a0ah,// sb sh1
...
///////////////////////////////////////////////////////////////////////////////////////
//! \fn void nmppsRShiftC_8u(nm8u *pSrcVec, int nShift, nm8u *pDstVec, int nSize) 
//!
//! \perfinclude _nmppsRShiftC_8u.html

global _nmppsRShiftC_8u:label;
<_nmppsRShiftC_8u>
.branch;
	ar5 = ar7 - 4;
	push ar0,gr0;
