...
data ".data_nmplv_G"
		...
		core_tbl_nb_sb_short_RSH:word[32]=(
			80028002h,// nb sh0
			000a000ah,// sb sh0
				0c002c002h,// nb sh1
				0000a000ah,// sb sh1
...
///////////////////////////////////////////////////////////////////////////////////////
//! \fn void nmppsRShiftC_16u(nm16u *pSrcVec, int nShift, nm16u *pDstVec, int nSize) 
//!
//! \perfinclude _nmppsRShiftC_16u.html

global _nmppsRShiftC_16u:label;
<_nmppsRShiftC_16u>
.branch;
	ar5 = ar7 - 4;
	push ar0,gr0;
