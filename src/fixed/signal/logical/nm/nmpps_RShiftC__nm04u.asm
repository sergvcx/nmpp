...
data ".data_nmplv_G"
		core_tbl_w_nm4u_RSH:long[64]=(
			...
			01000000000000000hl,04000000000000000hl);
			

		core_tbl_nb_sb_nm4u_RSH:word[8]=(
			0AAAAAAAAh,// nb sh0
			0AAAAAAAAh,// sb sh0
			0EEEEEEEEh,// nb sh1
			0AAAAAAAAh,// sb sh1
