...
data ".data_nmplv_G"
		...
		core_tbl_nb_sb_long_RSH:long[128]=(
...
///////////////////////////////////////////////////////////////////////////////////////
// 
//! \fn void nmppsRShiftC_64u(nm64u *pSrcVec, int nShift, nm64u *pDstVec, int nSize) 
//!
//! \perfinclude _nmppsRShiftC_64u.html

global _nmppsRShiftC_64u:label;
<_nmppsRShiftC_64u>
.branch;
	ar5 = ar7 - 4;
	push ar0,gr0;
	...
	ar0 = core_tbl_nb_sb_long_RSH with gr0<<=2;
	ar5-=2;
	ar0+= gr0		with gr7 = gr0>>3;
	nb1 = [ar0++]	with gr7--;
	sb  = [ar0]		with gr7 A>>=31;
	with gr0=gr7<< 2;
	ar0 = core_tbl_w_long_RSH with gr0=-gr0;
