...
data ".data_nmplv_G"
		...
		core_tbl_nb_sb_int_RSH:word[64]=(
			80000002h,// nb sh0
			0000000ah,// sb sh0
				0c0000002h,// nb sh1
				00000000ah,// sb sh1
...
///////////////////////////////////////////////////////////////////////////////////////
// 
//! \fn void nmppsRShiftC_32u(nm32u *pSrcVec, int nShift, nm32u *pDstVec, int nSize) 
//!
//! \perfinclude _nmppsRShiftC_32u.html

global _nmppsRShiftC_32u:label;
<_nmppsRShiftC_32u>
.branch;
	ar5 = ar7 - 4;
	push ar0,gr0;
