...
//! \fn void nmppsSplit_8s (const nm8s* src,  nm8s*  dst1, nm8s* dst2,  int size);	
//!
//! \perfinclude nmppsSplit_8s.html


global _nmppsSplit_8s:label;
<_nmppsSplit_8s>
...
.branch;
	...
	push ar4,gr4	with gr3=gr7;		// gr3 = 2
	push ar5,gr5;	
	...
	gr5=[--ar5];	//	int			nSize			// buffer size in 8-bit elements	:[0,16,32...]
