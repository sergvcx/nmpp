...
// nWindowSize=64
// 351891 
//! \fn void nmppsMedianX_16s(v4nm16s* pSrc4v, v4nm16s* pDst4v, int nWindowSize, int nMedianX, int nSize, void* pTmp0, void* pTmp1)
//! \perfinclude _nmppcMedian3_32u__FUiUiUi.html
global _nmppsMedianX_16s:label;
<_nmppsMedianX_16s>
