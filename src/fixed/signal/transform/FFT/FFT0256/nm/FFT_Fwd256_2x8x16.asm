...
//                                                                          //
//////////////////////////////////////////////////////////////////////////////
global _FFT_Fwd256_2x8x16	:label;
...
.repeat 4;
	rep 32 ram=[ar4];							// X[0..255]  
	rep 32 data=[ar5] with ram+data;			// S[0..255]=X[0..255]+X[256..511]
	rep 32 [ar1]=afifo;						
	rep 32 data=[ar5] with ram-data;			// S[256..511]=X[0..255]-X[256..511] 
	rep 32 [ar1]=afifo;
.endrepeat;
	...
	//* GSrcBuffer  * =>   * GBuffer1  *          *
	//*************** =>   ************************
	rep 8 wfifo=[ar2],ftw,wtw;			// GSrcBuffer
.repeat 31;
	rep 8  data=[ar1]         with vsum ,data,0;		// [L]	W1_256
	rep 8  [ar4]=afifo;							// [G]	GBuffer
	rep 8  wfifo=[ar2],ftw;						// [G]	GSrcBuffer
	rep 8  data=[ar1] with vsum ,data,0;	// [L]	LCosSin Table
	rep 8  [ar4]=afifo,wtw;							// [G]	GBuffer
...
//goto theend;
	...
	rep 8 [ar4]=afifo;							// [G]	GBuffer
	sb=gr2;
	rep 2 wfifo=[ar2],ftw;						// [G]	GSrcBuffer
	rep 8 data=[ar1] ,wtw with vsum ,data,0;	// [L]	LCosSin Table
	rep 8  [ar4]=afifo;							// [G]	GBuffer
...
.endrepeat;
	...
	rep 16 data =[ar1],ftw,wtw with vsum ,data,0;			// [G]	W2_256
	sb=gr2;
	rep 2  wfifo=[ar3];								// [L]	LAddCmplxMask
	rep 16 data =[ar1],ftw,wtw with vsum ,data,afifo;		// [G]	GWkn_256
	rep 16 [ar5]=afifo;								// [L]	LBuffer2
	ar6+=gr6;
	ar6+=gr6;
