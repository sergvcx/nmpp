...
//*                        for FFT_Inv2048 function (for NM6403 part)        */
//*                     (Use this programm to generate i2048tbl.asm)        */
//*                                                                         */
...
void IReSortW1_2048(vec<nmint64s > &WRe,
					vec<nmint64s > &WIm,
					vec<nmint64s > &Dst)
...
///////////////////////////////////////////////////////////////////
// Generation of two tables of sin-cos coefficients for FFT_Inv2048 function
// Output 2 Tables into stdout 
// Redirect stdout output to file for iW2048tbl.asm generation
// EXAMPLE:  Debug\pcIFFT2048.exe > iW2048tbl.asm
void IOutTableW1W2_2048(double Ampl,
...

{
	...
	IMakeTable2048W1W2(W1_2048,W2_2048,Ampl);
	...
	IReSortW1_2048(W1Pack8Re,W1Pack8Im,W1Table);
	IReSortW2_2048(W2Pack8Re,W2Pack8Im,W2Table);
