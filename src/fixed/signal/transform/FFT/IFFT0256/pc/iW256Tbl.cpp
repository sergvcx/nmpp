...
//*                        for FFT_Inv256 function (for NM6403 part)         */
//*                     (Use this programm to generate i256tbl.asm)         */
//*                                                                         */
...
void IReSortW1_256(	vec<nmint64s > &WRe,
					vec<nmint64s > &WIm,
					vec<nmint64s > &Dst)
{
...
// Redirect stdout output to file for iW256tbl.asm generation
// EXAMPLE:  Debug\pcIFFT256.exe > iW256tbl.asm
void IOutTableW1W2_256(double Ampl,
					  ...
					  char* W2_Name,char *W2_Section)
{
	...
	IMakeTable256W1W2(W1_256,W2_256,Ampl);
	...
	IReSortW1_256(W1Pack8Re,W1Pack8Im,W1Table);
	IReSortW1_256(W2Pack8Re,W2Pack8Im,W2Table);
