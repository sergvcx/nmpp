...
///////////////////////////////////////////////////////////////////////////////
//! \fn void nmppsCmpGt0_16s(nm16s* pSrcVec, nm16s* pDstVec, int nSize);
//!
//! \perfinclude _nmppsCmpGt0_16s.html

global _nmppsCmpGt0_16s:label;
<_nmppsCmpGt0_16s>
