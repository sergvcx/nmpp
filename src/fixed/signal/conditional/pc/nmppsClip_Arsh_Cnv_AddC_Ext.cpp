...
void nmppsClipArshCnv_AddC_Ext_Set(int *pnClip, int *pnShift, nm8s *pchC,  S_Clip_Arsh_Cnv_AddC_Ext *pParams);
void nmppsClipArshCnv_AddC_Ext_Exe(nm16s *pshSrc, S_Clip_Arsh_Cnv_AddC_Ext *pParams, nm8s *pchDst, int nSrcSize);
...
//------------------------------------------------------------------------
void nmppsClipArshCnv_AddC_Ext(v8nm16s *pSrc, v8nm32s *pnClip, v8nm32s *pnShift,    v8nm32s *pnAdd, v8nm8s *pDst, int nSrcSize)
{
    ...
    for(i=0; i<nSrcSize*8; i++)
    {
        ...
        //nmppsSetVal((nm8s*)pDst,i, (char)(shSrc >> nmppsGetVal((nm32s*)pnShift,i8)) + nmppsGetVal((nm32s*)pnAdd,i8));
		nmppsPut_8s((nm8s*)pDst,i, (char)(shSrc >> nmppsGet_32s((nm32s*)pnShift,i8)) + nmppsGet_32s((nm32s*)pnAdd,i8));
    }
}
//------------------------------------------------------------------------
void nmppsClipArshCnv_AddC_Ext_Set(int *pnClip, int *pnShift, nm8s *pchC, 
        S_Clip_Arsh_Cnv_AddC_Ext *pParams)
{
        
}
//------------------------------------------------------------------------
void nmppsClipArshCnv_AddC_Ext_Aux(nm16s *pshSrc, S_Clip_Arsh_Cnv_AddC_Ext *pParams, 
        nm8s *pchDst, int nSrcSize)
{

}
//------------------------------------------------------------------------
void nmppsClipArshCnv_AddC_Ext(nm16u *pnSrc, int *pnClip, int *pnShift, 
